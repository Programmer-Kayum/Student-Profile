...
import speed from '../../../photos/speed.png'

const Speed = () => {
    return (
        <div className='rounded-lg bg-gradient-to-r from-violet-500 to-fuchsia-500 py-10'>
        <h1 className='text-center font-bold text-4xl  '>Check Your Speed Type_</h1>
        ...
        <div className="card   mb-10  bg-gradient-to-r from-cyan-500 to-blue-500 
            hover:from-yellow-500 hover:to-pink-500 shadow-xl">
              <figure className="px-4  py-6">
                  <img src={speed} alt="Shoes" className="rounded-xl" />
              </figure>
         </div>
        <div className="card mx-4  mb-10  bg-gradient-to-r from-cyan-500 to-blue-500 
            hover:from-yellow-500 hover:to-pink-500 shadow-xl">
              <div className='text-center'>
        <a target='_blank' href="https://bright-wisp-f43225.netlify.app/"><button className=" pt-32 pb-4 font-bold text-4xl">Let's Start !!!</button></a> 

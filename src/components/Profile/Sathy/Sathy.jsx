...
import name from '../../../photos/profile/sathy.jpg'
  ...
  return (
    <div>
      ...
      <div>
          ...
          <div className='flex'>
      <div className='w-[80%]'>
          <h4 className='font-semibold text-2xl'> Student Name &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;  :  &nbsp;  Sharmin Akter Sathy</h4>
          ...
          <h4 className='font-semibold text-2xl'> Student ID   &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : &nbsp;   2002167</h4>

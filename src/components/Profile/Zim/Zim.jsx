...
import name from '../../../photos/profile/zim.jpg'
  ...
  return (
    <div>
      ...
      <div>
          ...
          <div className='flex'>
      <div className='w-[80%]'>
          <h4 className='font-semibold text-2xl'> Student Name &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;  :  &nbsp;  Khalid Hasan Zim</h4>
          ...
          <h4 className='font-semibold text-2xl'> Student ID   &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : &nbsp;   2002150</h4>
